package br.com.mrzoom.restwithspringbootandjava.integrationtests.controllers.withxml;
...
import br.com.mrzoom.restwithspringbootandjava.integrationtests.vo.pagedmodels.PagedModelPerson;
...
class PersonControllerXMLTest extends AbstractIntegrationTest {
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/313</href></links>"));
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/434</href></links>"));
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/633</href></links>"));
