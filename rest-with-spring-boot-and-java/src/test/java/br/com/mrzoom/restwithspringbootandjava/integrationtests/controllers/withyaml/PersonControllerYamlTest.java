...
class PersonControllerYamlTest extends AbstractIntegrationTest {
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/person/v1/313\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/person/v1/434\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/person/v1/633\""));
